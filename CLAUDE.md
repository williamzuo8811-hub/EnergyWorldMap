...
- **Every other data file appends** via `window.ENERGY_EXTRA = (window.ENERGY_EXTRA || []).concat([ ... ])`.
  ...
  `data-refresh2606c.js` 6400–6728 · `data-clients3.js` 6800–6978 · `data-mining2607.js` 7000–7024 ·
  `data-mining2608.js` 7100–7189 · `data-australia2608.js` 7200–7272 · `data-clients-mining.js` 7300–7355 ·
  `data-refresh2607.js` 7400–7472 · `data-refresh2608.js` 7500–7511.
...
- **"Recent" window**: controlled by `META.recentSince` (currently `'2026-01'`); `META.lastUpdated`
  (`'2026-07'`) is shown in the header. Bump both when refreshing the dataset.
