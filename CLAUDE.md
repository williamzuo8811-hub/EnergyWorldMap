...
tile map plots ~3,700 energy projects worldwide, filterable by category, region, status, and year,
...
E-house / MV switchgear / storage skids; the ~3,700 projects become the **opportunity pool** and `CLIENT_META`'s 54
...
- **Every other data file appends** via `window.ENERGY_EXTRA = (window.ENERGY_EXTRA || []).concat([ ... ])`.
  ...
  `data-refresh2606c.js` 6400–6728.
