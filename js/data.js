 ...
 * 全球能源项目世界地图 —— 数据层
 * -------------------------------------------------------------
 * 唯一数据源，便于替换 / 扩充。数据为公开信息整理（截至 2026-07），
 * 坐标、投资额为近似/示意值。
 *
 ...
 *   epc       可选：EPC/总承包情况（承包商、模式与关键分包；目前覆盖澳大利亚全部项目）
 *   epcStatus 可选：EPC 状态：已授标 / 未招标 / 未公开 / 不适用
 *             （'未招标' 是设备 BD 的窗口期信号；详情卡展示，🔧 EPC榜与"EPC未招标"筛选依赖此字段）
 * ============================================================= */
window.ENERGY = (function () {
  const META = { lastUpdated: '2026-07', recentSince: '2026-01', minInvestmentRMB: '5000 万元' };
  ...
  const PROJECTS = [
    /* ============ 可再生能源发电 ============ */
    { id: 1, name: '墨脱（雅鲁藏布江下游）水电工程', en: 'Medog / Yarlung Tsangpo Hydropower', country: '中国', region: '中国', cat: 'renewable', coord: [95.3, 29.3], cap: '规划装机约 60 GW', inv: 1670, invText: '约 1.2 万亿元', status: '在建', year: 2025, updated: '2026-06', owner: '中国雅江集团', flagship: true, desc: '全球规模最大水电工程，2025 年 7 月开工。',
    ...
    { id: 17, name: 'Khavda 可再生能源园区', en: 'Khavda RE Park', country: '印度', region: '南亚', cat: 'renewable', coord: [68.9, 23.9], cap: '规划 30 GW', inv: 200, invText: '约 200 亿美元', status: '在建', year: 2024, updated: '2026-06', owner: 'Adani', flagship: true, desc: '全球最大在建可再生能源园区。',
    ...
    { id: 35, name: 'Snowy 2.0 抽水蓄能', en: 'Snowy 2.0', country: '澳大利亚', region: '大洋洲', cat: 'storage', coord: [148.4, -35.9], cap: '2.2 GW / 350 GWh', inv: 90, invText: '约 120 亿澳元', status: '在建', year: 2024, updated: '2026-06', owner: 'Snowy Hydro', flagship: true, desc: '南半球最大抽水蓄能。',
      detail: '在新南威尔士雪山地区已有水库间开挖隧洞、加装可逆机组，装机 2.2 GW、储能约 350 GWh，是南半球最大的抽水蓄能工程。建成后可为澳大利亚高比例可再生电网提供长时调节与兜底，相当于一座超大型"水电池"。', epc: '土建EPC：Future Generation 联合体(Webuild牵头/Clough/美国Lane)；机电 Voith Hydro', epcStatus: '已授标' },
    { id: 36, name: 'Waratah 超级电池', en: 'Waratah Super Battery', country: '澳大利亚', region: '大洋洲', cat: 'storage', coord: [151.2, -33.0], cap: '850 MW / 1680 MWh', inv: 8, invText: '约 18 亿澳元', status: '投运', year: 2025, updated: '2026-06', owner: 'Akaysha Energy', flagship: false, desc: '南半球最大电池储能之一。',
      detail: '位于新南威尔士原电厂场地，规模 850 MW/1680 MWh，是南半球最大的电池储能项目之一。它充当电网的"减震器/缓冲器"，在线路故障时快速吞吐功率以保护输电通道，使既有线路能输送更多可再生电力。', epc: 'EPC(BoP总包)：Consolidated Power Projects(CPP)；电池 Powin，PCS eks(日立能源)，变压器 Wilson Transformer', epcStatus: '已授标' },
    ...
    { id: 52, name: 'UAE Stargate 数据中心', en: 'UAE Stargate (Abu Dhabi)', country: '阿联酋', region: '中东', cat: 'datacenter', coord: [54.45, 24.45], cap: '规划 5 GW', inv: 300, invText: '数百亿美元', status: '在建', year: 2026, updated: '2026-06', owner: 'G42 / Nvidia / OpenAI', flagship: true, desc: '美国境外最大 AI 数据中心集群。',
    ...
    { id: 64, name: '西悉尼国际机场', en: 'Western Sydney Airport', country: '澳大利亚', region: '大洋洲', cat: 'transport', coord: [150.7, -33.88], cap: '首期年 1000 万人次', inv: 75, invText: '约 110 亿澳元', status: '在建', year: 2026, updated: '2026-01', owner: 'WSA Co', flagship: false, desc: '悉尼第二机场。',
      detail: '位于悉尼西郊，计划 2026 年下半年投运，首期年吞吐约 1000 万人次，是悉尼第二个国际机场。机场配套新建专用地铁线与道路、电力网络，缓解金斯福德·史密斯机场的运力瓶颈并带动悉尼西部发展。', epc: '航站楼总包：Multiplex；场道与大宗土方：CPB+Acciona联合体', epcStatus: '已授标' },
    ...
    /* ============ 石油化工 · LNG ============ */
    { id: 69, name: '北方气田 LNG 扩能', en: 'North Field LNG Expansion', country: '卡塔尔', region: '中东', cat: 'petro', coord: [51.6, 25.9], cap: 'LNG 产能增至 142 MTPA', inv: 290, invText: '约 290 亿美元', status: '在建', year: 2024, updated: '2026-06', owner: 'QatarEnergy', flagship: true, desc: '全球最大 LNG 扩能工程。',
    ...
    { id: 71, name: 'Plaquemines LNG', en: 'Plaquemines LNG', country: '美国', region: '北美', cat: 'petro', coord: [-89.9, 29.5], cap: 'LNG 约 24 MTPA', inv: 250, invText: '约 250 亿美元', status: '在建', year: 2024, updated: '2026-06', owner: 'Venture Global', flagship: true, desc: '路易斯安那大型出口 LNG。',
    ...
    { id: 73, name: '阿拉斯加 LNG', en: 'Alaska LNG', country: '美国', region: '北美', cat: 'petro', coord: [-149.9, 61.2], cap: 'LNG 约 20 MTPA + 800mi 管道', inv: 440, invText: '约 440 亿美元', status: '规划', year: 2026, updated: '2026-06', owner: 'Glenfarne', flagship: true, desc: '北坡天然气液化出口。',
    ...
    { id: 76, name: '丹格特炼油厂', en: 'Dangote Refinery', country: '尼日利亚', region: '非洲', cat: 'petro', coord: [3.6, 6.45], cap: '65 万桶/日', inv: 200, invText: '约 200 亿美元', status: '投运', year: 2024, updated: '2026-06', owner: 'Dangote Group', flagship: true, desc: '全球最大单体炼油厂。',
      detail: '位于尼日利亚拉各斯莱基自贸区，加工能力 65 万桶/日，是全球最大的单一系列炼油厂，2024 年起投产。它扭转了西非长期依赖成品油进口的格局，使尼日利亚有望从原油出口国转变为成品油净出口国，并配套自备电厂与码头。' },
    { id: 77, name: 'Jafurah 页岩气田', en: 'Jafurah Shale Gas', country: '沙特阿拉伯', region: '中东', cat: 'petro', coord: [49.5, 25.0], cap: '中东最大非常规气田', inv: 1000, invText: '约 1000 亿美元', status: '投运', year: 2024, updated: '2026-06', owner: '沙特阿美', flagship: true, desc: '沙特"气代油"战略核心。',
      detail: '位于沙特东部，是中东最大的非常规（页岩）气田，沙特阿美计划投入约 1000 亿美元分阶段开发。增产的天然气用于发电、工业和制蓝氢，从而把更多原油腾出用于出口，是沙特"气代油"能源战略的核心工程。' },
    { id: 78, name: '北极 LNG-2', en: 'Arctic LNG 2', country: '俄罗斯', region: '欧洲', cat: 'petro', coord: [73.3, 71.5], cap: 'LNG 约 20 MTPA', inv: 210, invText: '约 210 亿美元', status: '在建', year: 2024, updated: '2026-06', owner: 'Novatek 等', flagship: false, desc: '北极圈重力式 LNG 工厂。',
      detail: '位于俄罗斯北极圈格丹半岛，由诺瓦泰克牵头，采用建在重力式基座（GBS）上的模块化液化线，规划产能约 2000 万吨/年。项目受西方制裁影响，在设备、船运与销售上进展受阻，是地缘政治对能源工程影响的典型案例。' },

    /* ============ 矿业 ============ */
    { id: 80, name: 'Simandou 铁矿', en: 'Simandou Iron Ore', country: '几内亚', region: '非洲', cat: 'mining', coord: [-8.9, 9.0], cap: '高品位铁矿 + 620km 铁路', inv: 230, invText: '约 230 亿美元', status: '投运', year: 2025, updated: '2026-06', owner: '力拓 / 中铝 / 赢联盟', flagship: true, desc: '全球最大在建高品位铁矿。',
